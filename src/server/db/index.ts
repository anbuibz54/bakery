 ...
 * bakery page fans out more than three queries at once; raise this if one
 * starts to.
 *
 * No `next/*` imports.
 */
...
const globalForDb = globalThis as unknown as {
  __bakeryDbClient?: ReturnType<typeof createClient>
}

const client = globalForDb.__bakeryDbClient ?? createClient()

if (process.env.NODE_ENV !== 'production') {
  globalForDb.__bakeryDbClient = client
}
