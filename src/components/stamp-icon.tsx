...
const PATHS = {
  ...
  instagram: {
    fill: 'M7 12a5 5 0 0 1 5-5h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H12a5 5 0 0 1-5-5z',
    line: 'M6 11a5 5 0 0 1 5-5h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H11a5 5 0 0 1-5-5z M11.5 16a4.5 4.5 0 1 0 9 0 4.5 4.5 0 1 0-9 0 M21.6 10.4h.1',
  },
  facebook: {
    fill: 'M6 15c0-5.5 4.5-9 11-9s11 3.5 11 9-4.5 9-11 9c-1.2 0-2.4-.1-3.5-.4L8 26l1-4.3C7 20 6 17.7 6 15z',
    line: 'M5 14.5C5 9 9.5 5.5 16 5.5S27 9 27 14.5 22.5 23.5 16 23.5c-1.2 0-2.4-.1-3.5-.4L7 25.5l1-4.3C6 19.5 5 17.2 5 14.5z M10.5 16.5l3.5-3.5 3 2.5 4.5-3.5',
  },
  tiktok: {
    fill: 'M15 7h3.5c.5 3 2.5 5 5.5 5.5V16c-2 0-4-.6-5.5-1.7V21a5.5 5.5 0 1 1-5.5-5.5v3.6a1.9 1.9 0 1 0 2 1.9z',
    line: 'M14 6h3.5c.4 3 2.4 5 5.5 5.4V15c-2 0-3.9-.6-5.5-1.7V20a5.5 5.5 0 1 1-5.5-5.5v3.6a1.9 1.9 0 1 0 2 1.9z',
  },
  gift: {
    fill: 'M7 15h20v12H7z',
